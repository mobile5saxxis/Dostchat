...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((DostChatApp) getApplication()).initWorkerThread();
    ...
    protected RtcEngine rtcEngine() {
        return ((DostChatApp) getApplication()).getWorkerThread().getRtcEngine();
    }

    protected final WorkerThread worker() {
        return ((DostChatApp) getApplication()).getWorkerThread();
    }

    protected final EngineConfig config() {
        return ((DostChatApp) getApplication()).getWorkerThread().getEngineConfig();
    }

    protected final MyEngineEventHandler event() {
        return ((DostChatApp) getApplication()).getWorkerThread().eventHandler();
    }
    ...
    protected CurrentUserSettings vSettings() {
        return DostChatApp.mVideoSettings;
    }
