...
public class CountriesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements RecyclerViewFastScroller.BubbleTextGetter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (SearchQuery == null) {
            ...
            if (index >= 0) {
                countryName.setSpan(new ForegroundColorSpan(AppHelper.getColor(mActivity, R.color.colorBlueLightSearch)), index, index + SearchQuery.length(), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
