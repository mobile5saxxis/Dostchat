...
public interface FilesUploadService {
    ...
    /**
     * method to upload backup
     *
     * @param backup this is  parameter for  uploadMessageBackup method
     * @return this is return value
     */
    @Multipart
    @POST(EndPoints.UPLOAD_MESSAGES_BACKUP)
    Call<BackupModel> uploadMessageBackup(@Part("msgBackup\"; filename=\"messagesBackup.realm\" ") UploadFilesHelper backup);
